...
- **pre-configured alarm types**: use the *preconfigured_alarm_type* attributes, assigning it a list of the following supported values: *high-cpu-alarm*, *instance-status-alarm*, *vm-maintenance-alarm*, *bare-metal-unhealthy-alarm*, *high-memory-alarm*, *adb-cpu-alarm*, *adb-storage-alarm*, *vpn-status-alarm*, *fast-connect-status-alarm*, *adb-failed-logins-critical-alarm*, *adb-failed-logins-warning-alarm*, *adb-monitoring-stopped-alarm*, *adb-sessions-warning-alarm* and *adb-storage-warning-alarm*. For the list of metrics in each of these types, check [preconfigured_alarms.tf file](./preconfigured_alarms.tf).
