...
1. [Alarms module](./alarms/)
  - Enhancement: Added 33 new [preconfigured alarm types](./alarms/preconfigured_alarms.tf) for Compute, Autonomous Database, Network, Exadata VM Cluster, and Exadata Database monitoring.
